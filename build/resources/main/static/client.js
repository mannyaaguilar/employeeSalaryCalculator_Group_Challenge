...
function getEmployees() {
    ...
    function postEmployee(event) {
        ...
        $("#biWeeklySalary").text("Monthly Salary Spend for the Company: $" + total / 12);
        $("#biMonthlySalary").text("Bi-Weekly Salary Spend for the Company: $" + total / 26);
        $("#annualSalary").text("Twice a Month Salary Spend for the Company: $" + total / 24);
